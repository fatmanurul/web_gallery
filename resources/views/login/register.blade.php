        ...
        <main class="form-signin">
          ...
          <form action="/login" method="post" data-parsley-validate> 
            ...
            <div class="form-floating">
                <input type="text" name="usr_email" class="form-control @error('usr_email') is-invalid @enderror" id="usr_email" autofocus  value="{{old('usr_email')}}" required data-parsley-inputs data-parsley-type="text">
                <label for="usr_email">Name</label>
                @error('usr_email')
            ...
            <p>Sudah daftar? <a href="/login">Login</a></p>
